...
DEFAULT_OUTPUT = Path(__file__).parent / "data" / "web_validation.jsonl"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Build a deterministic MAGE validation subset for length-aware "
...
def main() -> None:
    ...
    metadata = {
        "dataset": "MAGE validation length-aware calibration subset",
        "purpose": "calibration_only",
        "used_for_calibration": True,
        "used_for_external_test": False,
    ...
    print(f"Wrote {len(records)} calibration texts to {args.output}")
    print(json.dumps({
